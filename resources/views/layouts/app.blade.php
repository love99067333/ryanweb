...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-172980469-1"></script>
    <script>
...
<body>
    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-transparent" id="topnavbar">
            ...
            <div class="collapse navbar-collapse" style="background: #343a40;" id="navbarSupportedContent">
